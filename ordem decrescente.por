programa			//6-Faça um Programa que leia três números e mostre-os em ordem decrescente.
{
	funcao inicio()
	{
		...
		{
			escreva(" A ordem decrescente é: ", num1, ", ", num3, ", ", num2, ". \n")
		}
		se(num1 < num2 e num2 > num3 e num1 > num3)
		{
			escreva(" A ordem decrescente é: ", num2, ", ", num1, ", ", num3, ". \n")
		}
		se(num1 < num2 e num2 > num3 e num1 < num3)
		{
			escreva(" A ordem decrescente é: ", num2, ", ", num3, ", ", num1, ". \n")
		}
		se(num1 < num2 e num2 < num3)
		{
			escreva(" A ordem decrescente é: ", num3, ", ", num2, ", ", num1, ". \n")
		}
		se(num1 > num2 e num1 < num3)
		{
			escreva(" A ordem decrescente é: ", num3, ", ", num1, ", ", num2, ". \n")
		}
	}
}
/* $$$ Portugol Studio $$$ 
