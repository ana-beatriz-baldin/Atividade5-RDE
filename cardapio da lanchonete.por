	...
	funcao inicio()
	{
		...
		escolha(codigo_pedido)
		{
			caso 100: 
				...
				escreva("\n ", quantidade, " cachorro(s) quente(s) = ", total_pedido, " reais. \n")
				pare
				
			caso 101:
				total_pedido = quantidade * 2.60
				escreva("\n ", quantidade, " bauru(s) = ", total_pedido, " reais. \n")
				pare

			caso 102:
				total_pedido = quantidade * 3.80
				escreva("\n ", quantidade, " bauru(s) c/ ovo = ", total_pedido, " reais. \n")
				pare

			caso 103:
				total_pedido = quantidade * 9.00
				escreva("\n ", quantidade, " hamburguer(s) = ", total_pedido, " reais. \n")
				pare

			caso 104: 
				total_pedido = quantidade * 11.00
			 	escreva("\n ", quantidade, " cheeseburguer(s) = ", total_pedido, " reais. \n")
			 	pare

			caso 105: 
				total_pedido = quantidade * 3.00
				escreva("\n ", quantidade, " refrigerante(s) = ", total_pedido, " reais. \n")
				pare

			caso 106: 
				total_pedido = quantidade * 1000.00
				escreva("\n ", quantidade, " semente(s) dos deuses = ", total_pedido, " reais. \n")
				pare
